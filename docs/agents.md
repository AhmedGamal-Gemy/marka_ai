...
Marka AI uses Zensical for documentation. All docs are in the `docs/` folder.

```bash
uvx zensical serve      # preview docs at localhost:8000
uvx zensical build     # generate static site into /site
```

> API reference is auto-generated from code docstrings.
